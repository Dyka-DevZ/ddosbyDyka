...
def helptext ():
        print "AUTHOR:DYKA DAN....
        print "python2 %s (victim/ip) -t (10000) -c (10000) -p (80)" % sys.argv[0]
        print "WARNING:JIKA INGIN MENGGUNAKAN TOOLS INI WAJIB PAKAI VPN"!"
        print "===============COMMAND=============="
        print "   -t How much attack do you want to send"
        print "   -c How much bot/threads do you want to send"
        print "   -p (port)"
        print "JAN DI SHARE ATO DI JUAL MEMEK"
        print "===============NEWS==============="
        print "TOOLS KHUSUS MEMBER NCT"
        print "Auto Refuse 1 detik"
        print "DYKA Tools"
        print "============DIBACA MMK================"
        print " SAYA SEBAGAI AUTHOR TIDAK BERTANGGUNG JAWAB ATAS APA YANG TERJADI!"
        print " SUSPEND VPS "
        print "SUSPEND = 24/7 DDOS"
        print "WARNING CUMAN BUAT WAR BUKAN ABUSE KONTOL"
        print "=================================="
        exit()
...
def sender (num):
        ...
        col()
        print "Dyka[BOT] Hacking [69]! %d " % num
