...
def helptext ():
        ...
        print "   -p (port)"
        print "Tools Not For Sale"
        print "===============NEWS==============="
        print "This Tool is still BETA so many BUGS here!"
        print "Auto Refuse 1 seconds"
        print "Kryptonite Personal Tools"
        print "============UPDATE================"
        print " FIX BUG WHEN DDOSING 20%"
        print "ADDED SUSPEND VPS MODE"
...
def sender (num):
        ...
        col()
        print "Krypto[BOT] Hacking [69]! %d " % num
